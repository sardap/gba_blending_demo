...
#include "assets/background_32x32.h"
...
void init() {
	...
	dma3_cpy(&se_mem[BACKGROUND_SSB], background_32x32Map, background_32x32MapLen);
	...
	// Set bkg reg
	REG_BG0CNT = BG_PRIO(2) | BG_8BPP | BG_SBB(BACKGROUND_SSB) | BG_CBB(SHARED_CB) | BG_REG_32x32;
